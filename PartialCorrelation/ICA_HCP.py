...
for sub in subs:
    print "SUBJECT ", sub
    try:
        data = t_series(subject = "/scr/murg2/HCP_Q3_glyphsets_left-only/%s" % sub, 
...
savemat('/scr/murg2/MachineLearning/partialcorr/ICA/ICA_HCP/ica_HCP101_output_%s.mat' % str(n_components), {'ic':A})
