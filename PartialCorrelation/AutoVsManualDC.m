function [DiceCoef1, DiceCoef2, AvgDice] = AutoVsManualDC(subject, ext)

subject = num2str(subject);

auto_results = importdata(['/scr/murg2/MachineLearning/partialcorr/20comps_results/HCP_ICA_Indiv/' subject ext '.1D']);
...
manual_results = importdata(['/scr/murg2/MachineLearning/partialcorr/manual_results_' subject '.1D']);
